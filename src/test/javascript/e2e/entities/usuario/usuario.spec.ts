...
describe('Usuario e2e test', () => {
  ...
  it('should load Usuarios', async () => {
    ...
    expect(await usuarioComponentsPage.getTitle()).to.eq('gatewayFacturaApp.usuario.home.title');
  ...
  it('should load create Usuario page', async () => {
    ...
    expect(await usuarioUpdatePage.getPageTitle()).to.eq('gatewayFacturaApp.usuario.home.createOrEditLabel');
  ...
  /* it('should delete last Usuario', async () => {
        ...
        expect(await usuarioDeleteDialog.getDialogTitle())
            .to.eq('gatewayFacturaApp.usuario.delete.question');
