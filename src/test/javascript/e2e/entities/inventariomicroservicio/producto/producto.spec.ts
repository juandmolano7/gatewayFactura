...
describe('Producto e2e test', () => {
  ...
  it('should load Productos', async () => {
    ...
    expect(await productoComponentsPage.getTitle()).to.eq('gatewayFacturaApp.inventariomicroservicioProducto.home.title');
  ...
  it('should load create Producto page', async () => {
    ...
    expect(await productoUpdatePage.getPageTitle()).to.eq('gatewayFacturaApp.inventariomicroservicioProducto.home.createOrEditLabel');
  ...
  it('should create and save Productos', async () => {
    ...
    await promise.all([productoUpdatePage.setNombreInput('nombre'), productoUpdatePage.setPrecioInput('5')]);
  ...
  it('should delete last Producto', async () => {
    ...
    expect(await productoDeleteDialog.getDialogTitle()).to.eq('gatewayFacturaApp.inventariomicroservicioProducto.delete.question');
